...
<body>
	...
	<?php
			if (isset($_POST['new'])) {
				...
				echo '<p>'.$_POST['vopros5'].'</p><p>'.$_POST['text5_1'].'<input type="radio" name="var5.1"></p><p>'.$_POST['text5_2'].'<input type="radio" name="var5.2"></p>';
				echo '<p>'.$_POST['vopros6'].'</p><p>'.$_POST['text6_1'].'<input type="checkbox" name="var6.1"></p><p>'.$_POST["text6_2"].'<input type="checkbox" name="var6.2"></p><p>'.$_POST["text6_3"].'<input type="checkbox" name="var6.3"></p>';
				echo '<input type="submit" name="otpr" value="Отправить"></form><br>';
				echo 'http://php-3sem.std-925.ist.mospolytech.ru/opros.php <br>';
